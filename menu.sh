...
print_header() {  
  clear
  echo "╔════════════════════════════════════════════════════════════════════════════╗"
  echo "║   _nnnn_                      888      888     888 888    d8b 888          ║"
  echo "║  dGGGGMMb                     888      888     888 888    Y8P 888          ║"
  echo "║ @p~qp~~qMb                    888      888     888 888        888          ║"
  echo "║ M|@||@) M|   8888b.  .d8888b  88888b.  888     888 888888 888 888 .d8888b  ║"
  echo "║ @,----.JM|      \"88b 88K      888 \"88b 888     888 888    888 888 88K      ║"
  echo "║JS^\__/  qKL .d888888 \"Y8888b. 888  888 888     888 888    888 888 \"Y8888b. ║"
  echo "║dZP        qKRb  888      X88 888  888 Y88b. .d88P Y88b.  888 888      X88 ║"
  echo "║HZM            MMMM 88888P' 888  888  \"Y88888P\"   \"Y888 888 888  88888P' ║"
  echo "╚════════════════════════════════════════════════════════════════════════════╝"
  echo
}
